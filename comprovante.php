...
?>
        ...
        <p class="mensagem"><b>Usuario:<br> <?php echo $info['usuario']; ?></b></p> 
            <button class="fechar2" id="fechar2" type="" name="imprimir" onclick="window.print()">Enviar</button>
                <div><button  class="fechar3" id="fechar3"><a href="compartilhar.php?id=<?php echo $info['id']?>">Imprimir</a></button></div>
        </div>
