        ...
        <!-- FORMULARIO-->
            <form action="" method="POST">
                ...
                <label><span>Codigo de Barras:</span>               
                    <div><input value="<?php if(isset($_POST['codigo_barras'])) echo limpa_codigo($codigo_barras22);?>" placeholder="Cole o Codigo de Barras" class="campo-a" type="text" name="codigo_barras"/>
                ...
                <div><input  value="<?php if(isset($telefone)) echo $telefone;?>" type="text" id="phone" name="telefone" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);"></div>
                </label><br>
